...
let q=100000;
while (q){
    radix_sort([11,23,24,26,32,22,23,355,73,4325,46,58,5,345,23,523,523,11,23,24,26,32,22,23,355,73,4325,46,58,5,345,23,523,523]);
    q--;
}
console.log(new Date()-time,'ms');//11625 'ms' 当数字位数不固定时 效率极低
let time2 =new Date();
let p=100000;
while (p){
    [11,23,24,26,32,22,23,355,73,4325,46,58,5,345,23,523,523,11,23,24,26,32,22,23,355,73,4325,46,58,5,345,23,523,523].sort(function (a,b) {
        return a-b;
    });
    p--;
}
console.log(new Date()-time2,'ms');//197 'ms'